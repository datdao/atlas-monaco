...
describe('codecompletion', () => {
    ...
    describe('buildGlobalSearchCompletionItems', () => {
        test('default', () => {
            ...
            expect(completionItems).toEqual([codeCompletion.buildReferenceTemplate("users")])
        })
    ...
    describe('buildCompletionItems', () => {
        ...
        test('lvl2 suggestion', () => {
            const suggestions = hclNavigator.listSuggestionByNestedScopes(["table", "column"])
            const completionItems = codeCompletion.buildCompletionItems(suggestions, null as any)
        ...
        test('lvl2 value suggestion', () => {
            const suggestions = hclNavigator.listSuggestionByNestedScopes(["table", "column", "type"])
            const completionItems = codeCompletion.buildCompletionItems(suggestions, null as any)

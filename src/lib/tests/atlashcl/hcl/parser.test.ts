...
describe("regex", () => {
  describe("blockType", () => {
    test("default", () => {
      const result = regexdata.hclResourceLine.default.match(
        HCL_REGEX.blockType
      );
      expect(Array.from(result as RegExpMatchArray)).toEqual([
        'table "users" {',
        "table",
      ]);
    });
    ...
    test("haveBracketInValue", () => {
      const result = regexdata.hclResourceLine.haveBracketInValue.match(
        HCL_REGEX.blockType
      );
      expect(Array.from(result as RegExpMatchArray)).toEqual([
        'table "{}" {',
    ...
    test("uncomplete", () => {
      const result = regexdata.hclResourceLine.uncomplete.match(
        HCL_REGEX.blockType
      );
      expect(result).toBe(null);
    });
    ...
    test("uncompleteAndHaveBracketInValue", () => {
      const result =
        regexdata.hclResourceLine.uncompleteAndHaveBracketInValue.match(
          HCL_REGEX.blockType
        );
      expect(result).toBe(null);
    });
  ...
  describe("blockValue", () => {
    test("default", () => {
      ...
      while (
        (match = HCL_REGEX.blockValue.exec(
          regexdata.hclResourceLine.default
        )) !== null
      ) {
        values.push(match[1]);
      }
    ...
    test("multivalues", () => {
      ...
      while (
        (match = HCL_REGEX.blockValue.exec(
          regexdata.hclResourceLine.multivalues
        )) !== null
      ) {
        values.push(match[1]);
      }
  ...
  describe("attributeType", () => {
    test("default", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.attributeType.exec(
          regexdata.hclAttrLine.default
        )) !== null
      ) {
        values.push(match[1]);
      }
    ...
    test("defaultWithManySpace", () => {
      ...
      while (
        (match = HCL_REGEX.attributeType.exec(
          regexdata.hclAttrLine.defaultWithManySpace
        )) !== null
      ) {
        values.push(match[1]);
      }
    ...
    test("uncomplete", () => {
      ...
      while (
        (match = HCL_REGEX.attributeType.exec(
          regexdata.hclAttrLine.uncomplete
        )) !== null
      ) {
        values.push(match[1]);
      }
  ...
  describe("path", () => {
    test("default", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.path.exec(regexdata.hclPath.default)) !== null
      ) {
        values.push(match[0]);
      }
    ...
    test("multiPath", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.path.exec(regexdata.hclPath.multiPath)) !== null
      ) {
        values.push(match[0]);
      }
    ...
    test("uncomplete", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.path.exec(regexdata.hclPath.uncomplete)) !== null
      ) {
        values.push(match[0]);
      }
    ...
    test("endWithEnclosedCharacter", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.path.exec(
          regexdata.hclPath.endWithEnclosedCharacter
        )) !== null
      ) {
        values.push(match[0]);
      }
  ...
  describe("rawPath", () => {
    test("default", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.rawPath.exec(regexdata.hclRawPath.default)) !== null
      ) {
        values.push(match[0]);
      }
    ...
    test("array", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.rawPath.exec(regexdata.hclRawPath.array)) !== null
      ) {
        values.push(match[0]);
      }
    ...
    test("arrayWithEndClosedCharacter", () => {
      ...
      const values: string[] = [];
      while (
        (match = HCL_REGEX.rawPath.exec(
          regexdata.hclRawPath.arrayWithEndClosedCharacter
        )) !== null
      ) {
        values.push(match[0]);
      }
    ...
    test("withoutDotAtEnd", () => {
      ...
      while (
        (match = HCL_REGEX.rawPath.exec(
          regexdata.hclRawPath.withoutDotAtEnd
        )) !== null
      ) {
        values.push(match[0]);
      }
...
describe("parser", () => {
  ...
  describe("findParentBracket", () => {
    ...
    test("position at lvl3 with Direction down ", () => {
      ...
      const result = parser.findParentBracket(
        PairCurlyBracket,
        { lineNumber: 16, column: 43 } as any,
        1,
        Direction.down
      );
  ...
  describe("findReferencedResourceValues", () => {
    test("absolute path", () => {
      ...
      expect(result).toEqual(["users", "orders", "orders2", "customers"]);
    });
    ...
    test("absolute path lvl2", () => {
      ...
      const result = parser.findReferencedBlockValues([
        "table",
        "users",
        "column",
      ]);
    ...
    test("findReferencedResourceValues", () => {
      ...
      for (let line = 0; line < modeldata.textModel.getLineCount(); line++) {
        for (let column = 0; column < lines[line].length; column++) {
          ...
          parser.findReferencedBlockValues(
            getRandomElement([
              [""],
              ["table"],
              ["column", "users"],
